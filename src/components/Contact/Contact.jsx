          ...
          <div class="row animate-box">
            <div class="col-md-offset-2 text-center fh5co-heading">
              ...
              <p className="col-md-7 m-auto mb-5">
                With expertise in Data Science, Visualization, Data Engineering and a keen eye for
                Web Development, I deliver cutting-edge solutions tailored to your unique
